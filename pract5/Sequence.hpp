...
// Clase base abstracta Sequence: define el interfaz para una secuencia de elementos.
...
// Clase staticSequence: implementa una secuencia de tamaño fijo usando un vector.
template<typename Key>
...
public:
    ...
    // Acceso para lectura: verifica el índice y devuelve el elemento.
    ...
    // Acceso para escritura: verifica el índice y devuelve una referencia al elemento.
    ...
    // Método que retorna el tamaño de la secuencia.
