...
void printUsage(char* progName) {
    cout << "  Programa de algoritmos de ordenación\n";
    cout << "Instrucciones:\n";
...
int main(int argc, char* argv[]) {
    // Si se invoca el programa con '--help' y ningún otro parámetro, muestra el uso y finaliza.
    ...
    bool trace = false;     // Bandera para determinar si se imprimirá la traza
    ...
    for (int i = 1; i < argc; i++){
        if(strcmp(argv[i], "-size") == 0 && i+1 < argc) {
            ...
            // Configura la opción de traza (impresión intermedia de la secuencia).
            string t = argv[++i];
            trace = (t == "y" || t == "Y");
        }
    }
    ...
    // Se crea la secuencia de elementos tipo nif, de tamaño 'size'.
